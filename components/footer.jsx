...
const productLinks = [
  ...
  {
    title: "AI Skills Assessment (Coming Soon)",
    href: "#",
  },
  {
    title: "Career Transition Planner (Coming Soon)",
    href: "#",
  },
  {
    title: "Reskilling Pathways (Coming Soon)",
    href: "#",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-muted-foreground text-sm mb-4">
              ...
              confidence. Future-proof your career with AI-powered insights and
              tools.
            </p>
          </div>
