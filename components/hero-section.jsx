  ...
  return (
    <>
      ...
      <main className="overflow-x-hidden">
        <section>
          <div className="py-24 md:pb-32 lg:pb-36 lg:pt-20">
            <div className="relative mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
              <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                ...
                <p className="mt-8 max-w-2xl text-balance text-lg">
                  ...
                  career transitions, and build a future-ready resume that
                  stands out.
                </p>
                ...
                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                  ...
                  >
                    <Link href="#link">
                      <span className="text-nowrap">Start Free Analysis</span>
                  ...
                  >
                    <Link href="#link">
                      <span className="text-nowrap">Try Resume Scanner</span>
                    </Link>
                  </Button>
                </div>
              </div>
